...
decorationBackgroundColor(BuildContext context) {
  return boxDecoration(color: context.theme.colorScheme.surface, isGradient: true);
  //return boxDecoration(color: context.theme.backgroundColor, isGradient: true);
}

boxDecoration({Color? color, bool isGradient = false, double radius = 0}) {
  color = color ?? Get.theme.primaryColorDark;
...
boxDecorationRoundShadow({Color color = Colors.white}) {
  return BoxDecoration(
    color: color,
    borderRadius: const BorderRadius.all(Radius.circular(dp30)),
    boxShadow: [
      BoxShadow(
...
boxDecorationFullCircleShadow({Color color = Colors.white}) {
  return BoxDecoration(
    color: color,
    borderRadius: const BorderRadius.all(Radius.circular(dp100)),
    boxShadow: [
      BoxShadow(
          color: Colors.grey.withOpacity(0.3),
          spreadRadius: 1,
...
boxDecorationRoundBorderTop({Color bgColor = primary}) {
  return BoxDecoration(
    color: bgColor,
    borderRadius: const BorderRadius.vertical(top: Radius.circular(dp30)),
    boxShadow: [
      BoxShadow(
          color: Colors.grey.withOpacity(0.3),
          spreadRadius: 5,
...
boxDecorationRoundBorderBottom({Color bgColor = primary}) {
  return BoxDecoration(
    color: bgColor,
...
boxDecorationRoundOnly(
  ...
  bgColor = bgColor ?? Get.theme.colorScheme.surface;
  return BoxDecoration(
    color: bgColor,
    borderRadius: BorderRadius.only(
...
decorationSearchBox({VoidCallback? rightIconAction,  String? hint}) {
