...
//
//     final allProjectsResponse = allProjectsResponseFromJson(jsonString);

import 'dart:convert';

AllProjectsResponse allProjectsResponseFromJson(String str) => AllProjectsResponse.fromJson(json.decode(str));

String allProjectsResponseToJson(AllProjectsResponse data) => json.encode(data.toJson());
...
class AllProjectsResponse {
  ...
  factory AllProjectsResponse.fromJson(Map<String, dynamic> json) => AllProjectsResponse(
