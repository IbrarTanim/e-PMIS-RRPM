...
class WishListProjectsSurveyGalleryScreen extends StatefulWidget {
  final AllProjectsResponse? allProjectsResponse;
  //final ProjectsListResponse? allProjectsResponse;

  const WishListProjectsSurveyGalleryScreen(
      {Key? key, this.allProjectsResponse})
      : super(key: key);

  @override
  _WishListProjectsSurveyGalleryScreenState createState() =>
      _WishListProjectsSurveyGalleryScreenState();
}

class _WishListProjectsSurveyGalleryScreenState
    extends State<WishListProjectsSurveyGalleryScreen> {
...
/*    if (_controller.projectVideo.value.path.isNotEmpty) {
  ...
  void didUpdateWidget(
      covariant WishListProjectsSurveyGalleryScreen oldWidget) {
