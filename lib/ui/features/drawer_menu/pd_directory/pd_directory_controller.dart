...
class PdDirectoryController extends GetxController {
  ...
  void getDivisionDropDownList() {
    APIRepository().getMyProjectsDivisionDropDownList(selectedValueForMinistry.value.value ?? "")
        .then((resp) {
      hideLoadingDialog();
      if (resp.status == "success") {
        if (resp.data != null) {
  ...
  void getAgencyDropDownList() {
    ...
    APIRepository().getMyProjectsAgencyDropDownList(selectedValueForDivision.value.value ?? "")
        .then((resp) {
      hideLoadingDialog();
      if (resp.status == "success") {
        if (resp.data != null) {
