...
import 'all_projects_agency_wise_controller.dart';

class AllProjectsAgencyWiseScreen extends StatefulWidget {
  const AllProjectsAgencyWiseScreen({Key? key}) : super(key: key);

  @override
  _AgencyWiseScreenState createState() => _AgencyWiseScreenState();
}

class _AgencyWiseScreenState extends State<AllProjectsAgencyWiseScreen> {
  final _controller = Get.put(AllProjectsAgencyWiseController());
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: appBarWithBackAndActions(
          title: "Search_by_agency_wise".tr,
          actionIcons: [
          ...
          children: [
                  ...
                  Padding(
                      ...
                      child: NewDropDownAllProjectForAgency(
                          ...
                          onChange: (value) {
                            ...
                            _controller.getAllAgencyListFromAllProjects(false);
                            // _controller.getAllMinistryListFromAllProjects();
                          },
                          extraWidth: 89),
                    );
            ...
            Obx(() {
              ...
              /*textSpanAutoSize(
                          ...
                          subTitle: _controller.listResponse.value.paginationDto!.total
              ...
              child: ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  if (_controller.hasMoreData &&
                    ...
                    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
                      _controller.getAllAgencyListFromAllProjects(true);
                    });
                  }
