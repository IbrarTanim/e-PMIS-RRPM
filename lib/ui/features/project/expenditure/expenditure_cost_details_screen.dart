...
class NewProjectExpenditureCostDetailsScreen extends StatefulWidget {
  ...
  @override
  _NewProjectExpenditureCostDetailsScreenState createState() =>
      _NewProjectExpenditureCostDetailsScreenState();
}

class _NewProjectExpenditureCostDetailsScreenState
    extends State<NewProjectExpenditureCostDetailsScreen> {
      ...
      body: SafeArea(
        child: ListView.separated(
          ...
          itemBuilder: (context, index) {
            return NewProjectExpenditureCostDetailsItemView(projectExpenditureCostResponse: _wishListProjectDetailsController.projectExpenditureCostResponse[index],);
          },
        ),
      ),
    );
